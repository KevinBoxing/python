...
plt.grid(True,axis='both')
plt.show()
plt.plot(Close['2015'],'--rD',label='收盘价')
...
plt.plot(Open['2015'],'--b>',label='开盘价',lw=10)
plt.legend(loc='best')
plt.xlabel('日期')
plt.ylabel('价格')
plt.title('中国银行2015年开盘与收盘价曲线')
...
plt.bar(x=[2,3,4,5],height=a,width=1.0,bottom=2.0)
plt.title('中国银行收盘价分布柱状图')
plt.show()
plt.bar(x=[2,3,4,5],height=a,width=1.0,bottom=2.0,color='red',edgecolor='k')
plt.title('中国银行收盘价分布柱状图')
plt.show()
